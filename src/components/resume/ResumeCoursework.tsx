    ...
    return (
        <DecoratedSection className="border-t-2 border-white/50" showLine={false}>
            <div className="mx-auto max-w-6xl px-6 md:px-16 py-8 md:py-12">
                ...
                <p className="text-dark/85 italic text-sm md:text-base mb-8 md:mb-10">
                ...
                <div className="flex flex-col gap-6">
                    {courses.map((course) => (
                        <div key={course.name} className="border-b border-dark/10 pb-6 last:border-0 last:pb-0">
                            ...
                            <p className="text-dark/85 font-light text-sm md:text-base leading-relaxed mb-1">
                                {course.description}
                            </p>
                            <p className="text-dark/75 text-sm md:text-base leading-relaxed">
                                <span className="font-medium text-dark/85">Takeaway:</span> {course.takeaway}
                            </p>
                        </div>
                    ))}
                </div>
