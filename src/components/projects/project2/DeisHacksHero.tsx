        ...
        <DecoratedSection>
            <div className="mx-auto max-w-6xl px-6 md:px-16 pt-8 md:pt-14 pb-10 md:pb-16">
                ...
                <div className="flex flex-col gap-4 max-w-5xl">
                    ...
                    <p className="text-dark/60 font-light text-sm md:text-xl leading-relaxed">
                        DeisHacks is an annual social impact hackathon at Brandeis University that
                        brings together students and community partners to address real-world challenges
                        faced by local nonprofits. Over a 48-hour period, interdisciplinary teams
                        collaborate to develop practical solutions that improve visibility, visitor
                    ...
                    <p className="text-dark/60 font-light text-sm md:text-xl leading-relaxed">
                        ...
                        the Galleries. I structured these challenges to be both meaningful for the
                        organization and engaging for students, ensuring they were realistic,
                        actionable, and compelling within the hackathon format.
                    </p>
                    <p className="text-dark/60 font-light text-sm md:text-xl leading-relaxed">
                    ...
                    <p className="text-dark/60 font-light text-sm md:text-xl leading-relaxed">
                        ...
                        challenges and worked to attract and engage student participants in a highly
                    ...
                    <p className="text-dark/60 font-light text-sm md:text-xl leading-relaxed">
                        Overall, this project demonstrated my ability to lead through ambiguity, define
                        meaningful problems, and drive engagement in competitive environments. It also
                        reinforced the importance of combining research, structured thinking, and
                        leadership to guide teams toward impactful, real-world solutions.
                    </p>
                </div>
