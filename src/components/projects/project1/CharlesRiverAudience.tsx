        ...
        <DecoratedSection showLine={false}>
            <div className="mx-auto max-w-6xl px-6 md:px-16 py-8 md:py-12">
                    ...
                    {audiences.map((item) => (
                        <div key={item.label} className="flex flex-col items-center gap-2 text-center">
                            ...
                            <div>
                                ...
                                <p className="text-dark/75 font-light text-xs leading-relaxed first-letter:capitalize">{item.description}</p>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="hidden sm:flex flex-col gap-2 max-w-2xl">
                    {audiences.map((item) => (
                        <p key={item.label} className="text-dark/75 text-sm md:text-base leading-relaxed">
                ...
                <div className="flex flex-col gap-4 max-w-3xl mt-8">
                    ...
                    <div className="flex flex-col gap-3 mt-2">
                        <div>
                            ...
                            <p className="text-dark font-light text-sm md:text-base leading-relaxed">
