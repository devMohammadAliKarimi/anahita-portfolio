        ...
        <DecoratedSection lineClassName="top-8 h-16 md:top-16">
            <div className="mx-auto max-w-6xl px-6 md:px-16 pt-8 md:pt-14 pb-10 md:pb-16">
                ...
                <h2 className="text-dark/65 font-bold text-lg md:text-2xl w-full tracking-wide">
                    3. Driving Growth Through Data and Strategy
                </h2>

                <p className="text-dark/50 italic text-sm md:text-base mb-6">
                    Rivian: Market Analysis &amp; Strategy | Spring Semester 2025
                </p>
                ...
                <div className="flex flex-col gap-4 max-w-5xl">
                    ...
                    <p className="text-dark/60 font-light text-sm md:text-xl leading-relaxed">
                        Rivian operates in a highly competitive electric vehicle market, where established
                        players dominate market share. While the company has strong brand positioning and
                        innovative products, it faces challenges in scaling efficiently and achieving
                    ...
                    <p className="text-dark/60 font-light text-sm md:text-xl leading-relaxed">
                        By connecting data analysis with actionable strategy, this approach shows how
                        Rivian can move from current operational challenges toward sustainable growth.
                        Improving efficiency not only strengthens profitability but also supports
                        long-term scalability and competitiveness in the EV market.
                    </p>
                </div>
